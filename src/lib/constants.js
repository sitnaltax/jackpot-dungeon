...
export const RANKS = {
  ...
  silver:   { name: 'Silver',   multiplier: 1.5,  cost: 4, color: '#b0b0a0' },
  gold:     { name: 'Gold',     multiplier: 2, cost: 7, color: '#ffd700' },
  platinum: { name: 'Platinum', multiplier: 2.5,   cost: 10, color: '#e4e2f2' },
  diamond:  { name: 'Diamond',  multiplier: 3, cost: 14, color: '#83e8ff' },
};
