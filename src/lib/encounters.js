...
const ENCOUNTERS = [
  ...
  },
  {
    ...
    selectiveRedrawBonus: 0,
    description: null,
    flavorText: "It's not a pixie. It's not even a humanoid. It looks like a small, amorphous two-sided mirror. It flits through the air like a dragonfly, hovering and darting. As it darts around, it shows dizzying reflections, most from your surroundings, the rest from somewhere stranger and darker.",
  },
  {
  ...
  },
  {
    ...
    flavorText: "If you give a faerie what they want as part of a deal, they reliably keep their word. But this tiny brownie is asking for things you can't possibly provide: the color of seven, the first breath of a murderer, the bullet that killed Julius Caesar.",
  },
  {
    id: 'tooCleverFox',
    name: 'Too-Clever Fox',
  ...
  },
  {
    ...
    selectiveRedrawBonus: 0,
    description: null,
    flavorText: "A gust of wind blows, and the air fills with beautiful pink and lavender flower petals. You watch them swirl and drift, but when one lands on you, it strikes with the force of a hurled stone. Quickly you seek cover. ",
  },
  {
    id: 'invisibleBridge',
